  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 w-full z-50 transition-all duration-300 ${
        scrolled
          ? "bg-slate-950/95 backdrop-blur-2xl border-b border-sky-500/20 shadow-[0_12px_35px_rgba(0,0,0,0.85)] py-3"
          : "bg-[#090e1c]/95 backdrop-blur-xl border-b border-white/10 shadow-[0_8px_25px_rgba(0,0,0,0.6)] py-3.5 sm:py-4"
      }`}
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <nav className="hidden lg:flex items-center gap-1.5">
          ...
          <Link
            href="/#packages"
            className="px-4 py-2 rounded-xl text-sm font-bold text-slate-300 hover:text-sky-400 hover:bg-white/5 transition-all duration-200"
          >
            🌴 Destinations
          </Link>
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <a
            ...
            className="flex items-center gap-2 px-3.5 py-2 rounded-xl bg-slate-900/90 border border-slate-800 text-xs font-bold text-slate-200 hover:text-sky-400 hover:border-sky-500/40 hover:bg-sky-500/10 transition-all duration-300 group"
          >
        ...
        <div className="flex items-center gap-2 lg:hidden">
          <a
            href={`tel:${COMPANY_INFO.phone}`}
            className="p-2.5 rounded-xl bg-slate-800/80 border border-slate-700 text-sky-400 hover:bg-sky-500/20 transition-all"
            title="Call Us"
          >
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-slate-800/80 text-white border border-slate-700 hover:bg-slate-700 transition-colors cursor-pointer"
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden border-t border-slate-800/90 bg-slate-950/98 px-4 pt-3 pb-5 space-y-2 mt-3 animate-fade-in shadow-2xl">
          <Link
            href="/"
